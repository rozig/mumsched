...
INSERT INTO user(id, active, email, password, activation_token) VALUES
    ...
    (4, FALSE, 'student1@mum.edu', '$2a$10$8NFDu5a1mhVOiHavtl2cbOPXKTQNw2/9PEwJF1xhZvhyBj4mJrY4O', 'cc0af8d8-9339-4add-8b36-6167d30c56eb' ),
...
INSERT INTO block(id, name, start_date, end_date) VALUES
    ...
    (3, 'January 2018', '2018-01-02 00:00:00', '2018-02-01 00:00:00'),
    (4, 'February 2018', '2018-02-02 00:00:00', '2018-03-01 00:00:00'),
    (5, 'March 2018', '2018-03-02 00:00:00', '2018-04-01 00:00:00'),
    (6, 'April 2018', '2018-04-02 00:00:00', '2018-05-01 00:00:00'),
    (7, 'May 2018', '2018-05-02 00:00:00', '2018-06-01 00:00:00')
    ;
...
INSERT INTO faculty(id, description, firstname, lastname, user_id) VALUES
    (1, 'Mr President mfuckers', 'Ganzorig', 'Erdenebat', 1),
    (2, null, 'Faculty1 firstname', 'Faculty1 lastname', 5),
    (3, null, 'Faculty2 firstname', 'Faculty2 lastname', 6),
    (4, null, 'Faculty3 firstname', 'Faculty3 lastname', 7),
    (5, null, 'Faculty4 firstname', 'Faculty4 lastname', 8);
